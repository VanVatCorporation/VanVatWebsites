...
//document.querySelector('a[href="#vanvat-hoctap"]').addEventListener('click', (e) => {
//    e.preventDefault();
//    const studyPdfUrl = "https://placehold.co/600x800/png?text=Van+Vat+Hoc+Tap+Materials+PDF";
//    pdfUrlInput.value = studyPdfUrl;
//    onTargetFolderChange();
//    loadPdf();
//});