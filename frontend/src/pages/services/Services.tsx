...
const services = [
    ...
    { name: "Vạn Vật Học Tập", icon: GraduationCap, url: "/van-vat-corporation/van-vat-academy", desc: "Hệ thống học tập trực tuyến hiện đại." },
    { name: "Vạn Vật Drive", icon: Cloud, url: "/van-vat-corporation/van-vat-drive", desc: "Lưu trữ đám mây bảo mật & tốc độ cao." },
    ...
    { name: "Vạn Vật Cắm Trại", icon: Activity, url: "/van-vat-corporation/van-vat-camping", desc: "Dịch vụ booking và trải nghiệm thiên nhiên." },
    { name: "Vạn Vật Âm Nhạc", icon: Music, url: "/van-vat-corporation/van-vat-music", desc: "Cung cấp âm nhạc và giải trí không giới hạn." },
    ...
    { name: "Vạn Vật Sức Khỏe", icon: Stethoscope, url: "/van-vat-corporation/van-vat-healthcare", desc: "Chăm sóc sức khỏe và nha khoa hiện đại." },
